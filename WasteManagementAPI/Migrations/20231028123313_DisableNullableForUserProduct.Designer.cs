...
namespace WasteManagementAPI.Migrations
{
    ...
    [Migration("20231028123313_DisableNullableForUserProduct")]
    partial class DisableNullableForUserProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WasteManagementAPI.Models.DomainModels.SumOfWeghitOfProducts", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SumOfWeghitOfProducts");
                });
            ...
            modelBuilder.Entity("WasteManagementAPI.Models.DomainModels.SumOfWeghitOfProducts", b =>
                {
                    b.HasOne("WasteManagementAPI.Models.DomainModels.Citizen", "Citizen")
                        .WithOne("SumOfWeghitOfProducts")
                        .HasForeignKey("WasteManagementAPI.Models.DomainModels.SumOfWeghitOfProducts", "CitizenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WasteManagementAPI.Models.DomainModels.Citizen", b =>
                {
                    b.Navigation("SumOfWeghitOfProducts")
                        .IsRequired();
                });
